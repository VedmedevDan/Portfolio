...
LOCK TABLES `teacher_degree` WRITE;
/*!40000 ALTER TABLE `teacher_degree` DISABLE KEYS */;
INSERT INTO `teacher_degree` VALUES (1,'доцент'),(2,'професор');
/*!40000 ALTER TABLE `teacher_degree` ENABLE KEYS */;
UNLOCK TABLES;
